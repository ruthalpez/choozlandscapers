      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Landscapers Terms of Service
          </h1>
          <p>
            These Terms of Service govern your use of the website located at
            https://choozlandscapers.com and any related services provided by Chooz
            Landscapers.
          </p>
          <p>
            By accessing https://choozlandscapers.com, you agree to abide by these
            ...
            other services provided by Chooz Landscapers.
          </p>
          <p>
            We, Chooz Landscapers, reserve the right to review and amend any of
        ...
        <div className="mb-5">
          ...
          <ul className="space-list list-disc pl-5">
            ...
            <li>
              ...
              other service Chooz Landscapers provides
            </li>
            <li>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            are owned by or licensed to Chooz Landscapers and are protected by
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            is' basis. To the extent permitted by law, Chooz Landscapers makes no
          ...
          <p>
            In no event shall Chooz Landscapers or its suppliers be liable for any
            ...
            materials on this website, even if Chooz Landscapers or an authorized
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            for general information purposes only. Chooz Landscapers does not
        ...
        <div className="mb-5">
          ...
          <p>
            Chooz Landscapers has not reviewed all of the sites linked to its
            website and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement, approval
            or control by Chooz Landscapers of the site. Use of any such linked
